        ...
        {loading ? (
          ...
          <div className="mt-4 space-y-3">
            {farmers.map(f => {
              ...
              const farmerName = f.farmer_name || t('farmerFallback')
              return (
                <div
                  ...
                  onKeyDown={(e) => {
                    if (e.key === 'Enter' || e.key === ' ') {
                      e.preventDefault()
                      router.push(`/facilitator/promoted-farmers/${f.subscription_id}/advisory`)
                    }
                  }}
                  className="block w-full text-left bg-white rounded-2xl p-4 border border-[#DDD0B8] shadow-sm hover:border-[#7D4E00] transition-colors cursor-pointer">

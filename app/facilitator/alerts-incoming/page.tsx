                ...
                <>
                  ...
                  <div className="space-y-3">
                    {visibleRows.map(r => {
                      ...
                      // For START_DATE alerts the time anchor is the very
                      // thing the farmer hasn't set — showing "Started …"
                      // there would mock the alert. Drop it.
                      ...
                      const refLine = [subRef, company].filter(Boolean).join(' · ')
                      return (
                        <div
                          key={r.alert_id}

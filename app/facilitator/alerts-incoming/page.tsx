...
export default function FacilitatorAlertsIncomingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F0E8]">
      <PWAHeader title="Alerts I receive" activeRole="FACILITATOR" back="/facilitator/home" />
              ...
              <div className="space-y-3">
                {rows.map(r => (
                  <button
                    ...
                    onClick={() => router.push(`/facilitator/promoted-farmers/${r.subscription_id}/advisory`)}
                    className="w-full text-left bg-white rounded-2xl border border-[#DDD0B8] p-4 hover:border-[#7D4E00] transition-colors">

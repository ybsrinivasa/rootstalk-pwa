  ...
  return (
    <div className="min-h-screen bg-[#F5F0E8]">
      ...
      <div className="pt-16 pb-20 px-4">
        ...
        {/* ── Hero user card ── */}
        <div className="bg-white rounded-2xl p-5 mt-4 border border-[#DDD0B8] shadow-sm">
          <div className="flex items-center gap-4 mb-4">
            ...
            <label className="relative shrink-0 cursor-pointer">
              ...
              <span className="absolute -bottom-0.5 -right-0.5 w-5 h-5 rounded-full bg-white border border-[#DDD0B8] flex items-center justify-center">
                {uploadingPhoto ? (
                  <span className="w-2.5 h-2.5 border border-[#DDD0B8] border-t-[#3A7D44] rounded-full animate-spin"/>
                ) : (
                  <svg className="w-3 h-3 text-[#7A8C7E]" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
          ...
          {photoError && (
            <p className="text-[#D4682E] text-xs mb-2">{photoError}</p>
          )}

          {/* Edit profile section */}
          <div className="border-t border-[#DDD0B8] pt-3 space-y-3">
                      ...
                      <div>
                        ...
                        {stateId ? (
                          ...
                          <>
                            ...
                            {/* Full state list always visible so users
                                can tap directly; search is optional.
                                Anchor 2026-08-30 field feedback. */}
                            <div className="mt-1 border border-[#DDD0B8] rounded-xl overflow-hidden max-h-48 overflow-y-auto bg-white">
                              {filteredStates.length === 0
                                ...
                                : filteredStates.map(s => (
                                  <button key={s.cosh_id}
                                    ...
                                    className="w-full text-left px-3 py-2 text-sm text-[#6B3F1F] hover:bg-[#F5F0E8] border-b border-[#DDD0B8] last:border-0">
                                    {s.name}
                                  </button>
                                ))
                              }
              ...
              return (
                <div>
                  ...
                  {hasGps ? (
                    ...
                    <button onClick={captureGps} disabled={gpsLoading}
                      className="w-full py-2.5 rounded-xl border-2 border-dashed border-[#DDD0B8] text-xs text-[#7A8C7E] font-medium flex items-center justify-center gap-2">
        ...
        <div className="fixed inset-0 z-50 bg-black/40 flex items-end" onClick={() => setDeleteStep('idle')}>
          <div className="bg-white rounded-t-3xl w-full pb-10 px-5 pt-6" onClick={e => e.stopPropagation()}>
            ...
            <input
              ...
              placeholder="· · · · · ·"
              autoFocus
              className="w-full border border-[#DDD0B8] rounded-2xl px-4 py-5 text-center text-3xl font-mono tracking-[0.7em] text-[#6B3F1F] focus:outline-none focus:ring-2 focus:ring-red-200 focus:border-red-400 mb-4"
            />
            {deleteError && <p className="text-[#D4682E] text-sm mb-3">{deleteError}</p>}

      ...
      <div className="pt-20 pb-24 px-4 space-y-4 max-w-lg mx-auto">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          {/* 2026-07-04 — Shop Details tile removed from dashboard;
              ...
              so dealers who couldn't find a brand while marking
              availability have a visible outlet to send it to us. */}
          <button onClick={() => router.push('/dealer/brand-forms')}
            className="relative bg-white rounded-2xl p-4 border border-[#DDD0B8] shadow-sm text-left">
            {brandFormsUnread > 0 && (
              <span className="absolute top-3 right-4 min-w-[22px] h-[22px] px-1.5 rounded-full bg-red-500 text-white text-[11px] font-bold flex items-center justify-center">
                {brandFormsUnread}
              </span>
            )}

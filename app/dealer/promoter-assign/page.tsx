            ...
            <div>
              ...
              <div className="space-y-2 mb-4">
                ...
                {dealerships.filter(d => d.manufacturer_client_id).length === 0 && (
                  <p className="text-xs text-slate-500 py-2">No registered companies in your dealerships. Add companies first.</p>
                )}
              </div>
            ...
            <div>
                ...
                <div className="space-y-2">
                  {crops.map(c => (
                    <button
                      ...
                      disabled={loading}
                      className="w-full text-left px-4 py-3.5 rounded-xl border border-slate-200 bg-white text-sm font-medium text-slate-800 hover:border-[#085041] hover:text-[#085041] transition-colors disabled:opacity-40">
              ...
              {loading && (
                <div className="flex justify-center py-6">
                  <div className="w-6 h-6 border-2 border-slate-200 border-t-[#085041] rounded-full animate-spin" />
                </div>
              )}
